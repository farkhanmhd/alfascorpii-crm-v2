...
const CustomerFilters = ({
  ...
  const handleFilter = () => {
    ...
    if (holidayValue !== 'all') params.set('holiday_id', holidayValue);
    else params.delete('holiday_id');

    if (jobValue !== 'all') params.set('job_id', jobValue);
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] gap-6">
      ...
      <SelectFilter
        ...
        options={holidays}
        value={holidayValue}
        setSelectedValue={setHolidayValue}
      />
      <SelectFilter
        label="Pekerjaan"
        id="job"
